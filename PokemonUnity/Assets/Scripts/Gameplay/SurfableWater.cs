...
public class SurfableWater : MonoBehaviour, Interactable, IPlayerTriggerable
{
    ...
    public IEnumerator Interact(Transform initiator)
    {
        ...
        yield return DialogManager.Instance.ShowDialogText("A água é profunda!");
        ...
        if (pokemonWithSurf != null)
        {
            ...
            yield return DialogManager.Instance.ShowDialogText($"{pokemonWithSurf.Base.Name} deve usar Surf?",
            ...
            {
                // Yes
                yield return DialogManager.Instance.ShowDialogText($"{pokemonWithSurf.Base.Name} usou Surf.");
